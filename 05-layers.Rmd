...
They can serve several functions, from naming features, indicating relations between them, or representing values of a given variable.
The main function to create text labels is `tm_text()`, 

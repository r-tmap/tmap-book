...
```{r tmsymshape, fig.asp=0.66, echo=FALSE, fig.cap="Examples of two maps with different symbols: (a) and (B)."}
tmsymshape1 = tm_shape(metro) +
  tm_symbols(shape = "group") +
  tm_layout(title = "A")
tmsymshape2 = tm_shape(metro) +
 tm_symbols(shape = "group",
            title.shape = "Group:") +
  tm_layout(title = "B")
tmap_arrange(tmsymshape1, tmsymshape2, ncol = 1)
```

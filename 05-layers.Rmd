...
**RColorBrewer** builds upon a set of perceptually ordered color palettes [@harrower_colorbrewer_2003], which can be also explored at the associated website https://colorbrewer2.org.
...
The **viridis** package  http://bids.github.io/colormap/

...
<!--JN: Idea - add possible aesthetics to the above table-->
...
Text labels can also be modified with a set of unique arguments.
It includes `case` (`"upper"` or `"lower"`), `shadow` (`TRUE` or `FALSE`), `fontface` and `fontfamily`.
<!-- ref to the text section?? -->

Text labels can be added to spatial points, lines, and polygons.

...
<!-- discrete -->
```{r discrete-methods, warning=FALSE, fig.asp=NA, fig.height=3.46, message=FALSE, echo=FALSE, fig.cap="Examples of four method of creating discrete maps: (1) default method ('pretty'), (2) the 'fixed' method with manually set breaks, (3) the 'jenks' method, and (4) the 'log10_pretty' method."}
tm_pre = tm_shape(x) +
  tm_polygons(col = "gdpPercap") +
  tm_layout(title = "1")
tm_fix = tm_shape(x) +
...
```{r, warning=FALSE, fig.asp=NA, fig.height=3.46, message=FALSE, echo=FALSE}
tm_con = tm_shape(x) +
  tm_polygons(col = "gdpPercap",
              style = "cont")
tm_ord = tm_shape(x) +

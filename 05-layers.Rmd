...
<!-- how color palettes can be created -->
<!-- vector of color names or hex colors -->
<!-- color names - `colors()` -->
<!-- hex names - whats that -->
<!-- it allows everyone to create their own color palettes -->
<!-- however this is a hard thing to do right -->

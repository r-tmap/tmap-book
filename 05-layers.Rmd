...
```{r palette-types, fig.cap="Examples of three main types of color palettes: categorical, sequential, and diverging", echo=FALSE, fig.asp=0.667}
...
y = list(Categorical = list(p_cat, p_cat2),
         Sequential = list(p_seq, p_seq2),
         Diverging = list(p_div, p_div2))

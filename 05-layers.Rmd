...
```{r tmmidpoint, warning=FALSE, fig.cap="Examples of (1) a map with the default sequential color palette and (2) a map with the diverging color palette around the midpoint value of 73.", fig.asp=NA, fig.height=2, echo=FALSE}

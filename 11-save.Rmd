...
The advantage of vector graphics over raster graphics is that they can be zoom in and out without any decrease in quality.
On the other hand, vector graphics are not suitable for storing complex images or maps, and they are less supported by web browsers comparing to rasters.
...
Similar to the example in the previous section, we can also use other graphic devices here, such as `device = svglite::svglite`.

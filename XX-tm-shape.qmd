...
The second way is the most straightforward, but it is important to remember that the `crs` argument can be only set in the main layer (@sec-shapes-hierarchy).

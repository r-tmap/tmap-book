...
Look at the following example and try to guess how many *groups* it has, and how many layers exist for each *group*.
...
Often, maps have also additional map elements, such as graticule lines, north arrow,  scale bar, or map credits. 
<!-- explain -->

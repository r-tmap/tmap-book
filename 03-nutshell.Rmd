...
```{r imap1, echo=FALSE, fig.cap="(ref:imap1)", cache=FALSE}
# htmlwidgets::saveWidget(tmap_leaflet(my_map), file = "widgets/imap1.html")
# knitr::include_url("https://r-tmap.github.io/tmap-book/widgets/imap1.html")
widgetframe::frameWidget(tmap_leaflet(my_map))
```

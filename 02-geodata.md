...
The `srtm.tif` attribute is a matrix, where is cell represents an elevation value.
...
#> x       1 1128  301905    30 WGS 84 / UTM zone 12N
#> y       1 1428 4154085   -30 WGS 84 / UTM zone 12N
#> band    1    2      NA    NA                    NA
#>      point values    
#> x    FALSE   NULL [x]
#> y    FALSE   NULL [y]
...
Internally, it is a list of `matrix` or `array` objects with additional attributes describing spatial metadata, such as a number of columns and rows, resolution, coordinate reference system, etc.

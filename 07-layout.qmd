...
Text annotations can also be further customized, by changing their sizes (`size`), colors (`color`), positions, and fonts (section \@ref(fonts-on-maps)).

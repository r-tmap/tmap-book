...
* Chapter titles: which style? Options: ing-verb (e.g. "Creating maps with tmap"), noun (e.g. "Map creation with tmap"), question (e.g. "How to create maps with tmap?"). Should be more-or-less consisent I think.

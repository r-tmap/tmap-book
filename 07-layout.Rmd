...
```{r grids, fig.cap="(A), (B), (C).", echo=FALSE, fig.asp=0.33}
tmap_arrange(
    <<grid1>>
      + tm_layout(title = "A"),
    <<grid2>>
...
Alternatively, `position` can be specified with numeric values between 0 and 1 reepresenting the x and y value of the left bottom corner of the north arrow.

...
#> options, oo, doo): GDAL Message 1: /tmp/RtmpTEO8UZ/
#> file40415cfc2f8e.tif, band 2: Setting nodata to
...
#> Warning in CPL_gdalwarp(source, destination,
#> options, oo, doo): GDAL Message 1: /tmp/RtmpTEO8UZ/
#> file40415cfc2f8e.tif, band 3: Setting nodata to
...
#> Warning in CPL_gdalwarp(source, destination,
#> options, oo, doo): GDAL Message 1: /tmp/RtmpTEO8UZ/
#> file40415cfc2f8e.tif, band 4: Setting nodata to

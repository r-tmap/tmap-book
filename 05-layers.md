...
#> options, oo, doo): GDAL Message 1: /tmp/RtmpUOqtCF/
#> file3ffb714cd13b.tif, band 2: Setting nodata to
...
#> Warning in CPL_gdalwarp(source, destination,
#> options, oo, doo): GDAL Message 1: /tmp/RtmpUOqtCF/
#> file3ffb714cd13b.tif, band 3: Setting nodata to
...
#> Warning in CPL_gdalwarp(source, destination,
#> options, oo, doo): GDAL Message 1: /tmp/RtmpUOqtCF/
#> file3ffb714cd13b.tif, band 4: Setting nodata to

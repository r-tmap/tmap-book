...
#> options, oo, doo): GDAL Message 1: /tmp/RtmpzfhVU4/
#> filec8a4521fa3c.tif, band 2: Setting nodata to
...
#> Warning in CPL_gdalwarp(source, destination,
#> options, oo, doo): GDAL Message 1: /tmp/RtmpzfhVU4/
#> filec8a4521fa3c.tif, band 3: Setting nodata to
...
#> Warning in CPL_gdalwarp(source, destination,
#> options, oo, doo): GDAL Message 1: /tmp/RtmpzfhVU4/
#> filec8a4521fa3c.tif, band 4: Setting nodata to

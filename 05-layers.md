...
#> options, oo, doo): GDAL Message 1: /tmp/Rtmp23xXqv/
#> file3ee34a5f911e.tif, band 2: Setting nodata to
...
#> Warning in CPL_gdalwarp(source, destination,
#> options, oo, doo): GDAL Message 1: /tmp/Rtmp23xXqv/
#> file3ee34a5f911e.tif, band 3: Setting nodata to
...
#> Warning in CPL_gdalwarp(source, destination,
#> options, oo, doo): GDAL Message 1: /tmp/Rtmp23xXqv/
#> file3ee34a5f911e.tif, band 4: Setting nodata to

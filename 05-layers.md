...
#> options, oo, doo): GDAL Message 1: /tmp/RtmpxiIzzy/
#> file4c941aa56258.tif, band 2: Setting nodata to
...
#> Warning in CPL_gdalwarp(source, destination,
#> options, oo, doo): GDAL Message 1: /tmp/RtmpxiIzzy/
#> file4c941aa56258.tif, band 3: Setting nodata to
...
#> Warning in CPL_gdalwarp(source, destination,
#> options, oo, doo): GDAL Message 1: /tmp/RtmpxiIzzy/
#> file4c941aa56258.tif, band 4: Setting nodata to

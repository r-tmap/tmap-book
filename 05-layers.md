...
#> options, oo, doo): GDAL Message 1: /tmp/RtmpaDLQe9/
#> file444b4d9f8b26.tif, band 2: Setting nodata to
...
#> Warning in CPL_gdalwarp(source, destination,
#> options, oo, doo): GDAL Message 1: /tmp/RtmpaDLQe9/
#> file444b4d9f8b26.tif, band 3: Setting nodata to
...
#> Warning in CPL_gdalwarp(source, destination,
#> options, oo, doo): GDAL Message 1: /tmp/RtmpaDLQe9/
#> file444b4d9f8b26.tif, band 4: Setting nodata to

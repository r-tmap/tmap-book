...
#> options, oo, doo): GDAL Message 1: /tmp/RtmpDP6tAr/
#> file44e02a50eddd.tif, band 2: Setting nodata to
...
#> Warning in CPL_gdalwarp(source, destination,
#> options, oo, doo): GDAL Message 1: /tmp/RtmpDP6tAr/
#> file44e02a50eddd.tif, band 3: Setting nodata to
...
#> Warning in CPL_gdalwarp(source, destination,
#> options, oo, doo): GDAL Message 1: /tmp/RtmpDP6tAr/
#> file44e02a50eddd.tif, band 4: Setting nodata to

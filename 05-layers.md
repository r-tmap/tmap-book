...
#> options, oo, doo): GDAL Message 1: /tmp/RtmpMG9IBd/
#> file4927db999cc.tif, band 2: Setting nodata to
...
#> Warning in CPL_gdalwarp(source, destination,
#> options, oo, doo): GDAL Message 1: /tmp/RtmpMG9IBd/
#> file4927db999cc.tif, band 3: Setting nodata to
...
#> Warning in CPL_gdalwarp(source, destination,
#> options, oo, doo): GDAL Message 1: /tmp/RtmpMG9IBd/
#> file4927db999cc.tif, band 4: Setting nodata to

...
#> options, oo, doo): GDAL Message 1: /tmp/RtmpQiQome/
#> file53be6cc14b7d.tif, band 2: Setting nodata to
...
#> Warning in CPL_gdalwarp(source, destination,
#> options, oo, doo): GDAL Message 1: /tmp/RtmpQiQome/
#> file53be6cc14b7d.tif, band 3: Setting nodata to
...
#> Warning in CPL_gdalwarp(source, destination,
#> options, oo, doo): GDAL Message 1: /tmp/RtmpQiQome/
#> file53be6cc14b7d.tif, band 4: Setting nodata to

...
#> options, oo, doo): GDAL Message 1: /tmp/RtmpoAqIrZ/
#> file5256494cbb91.tif, band 2: Setting nodata to
...
#> Warning in CPL_gdalwarp(source, destination,
#> options, oo, doo): GDAL Message 1: /tmp/RtmpoAqIrZ/
#> file5256494cbb91.tif, band 3: Setting nodata to
...
#> Warning in CPL_gdalwarp(source, destination,
#> options, oo, doo): GDAL Message 1: /tmp/RtmpoAqIrZ/
#> file5256494cbb91.tif, band 4: Setting nodata to

...
Is it a <!--qualitative-->categorical variable where each value represents a <!--orderless-->group or a <!--quantitative-->numerical variable in which values can be ordered.
...
<!-- color perception, relation to data, color blindness, etc. -->

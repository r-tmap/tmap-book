...
#> options, oo, doo): GDAL Message 1: /tmp/RtmppxY11O/
#> file44b04c383fdd.tif, band 2: Setting nodata to
...
#> Warning in CPL_gdalwarp(source, destination,
#> options, oo, doo): GDAL Message 1: /tmp/RtmppxY11O/
#> file44b04c383fdd.tif, band 3: Setting nodata to
...
#> Warning in CPL_gdalwarp(source, destination,
#> options, oo, doo): GDAL Message 1: /tmp/RtmppxY11O/
#> file44b04c383fdd.tif, band 4: Setting nodata to

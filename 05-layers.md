...
#> options, oo, doo): GDAL Message 1: /tmp/RtmpNeGNHb/
#> file4fa972ef2aed.tif, band 2: Setting nodata to
...
#> Warning in CPL_gdalwarp(source, destination,
#> options, oo, doo): GDAL Message 1: /tmp/RtmpNeGNHb/
#> file4fa972ef2aed.tif, band 3: Setting nodata to
...
#> Warning in CPL_gdalwarp(source, destination,
#> options, oo, doo): GDAL Message 1: /tmp/RtmpNeGNHb/
#> file4fa972ef2aed.tif, band 4: Setting nodata to

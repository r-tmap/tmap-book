...
#> options, oo, doo): GDAL Message 1: /tmp/Rtmpe3nG2L/
#> file4c8a277778a5.tif, band 2: Setting nodata to
...
#> Warning in CPL_gdalwarp(source, destination,
#> options, oo, doo): GDAL Message 1: /tmp/Rtmpe3nG2L/
#> file4c8a277778a5.tif, band 3: Setting nodata to
...
#> Warning in CPL_gdalwarp(source, destination,
#> options, oo, doo): GDAL Message 1: /tmp/Rtmpe3nG2L/
#> file4c8a277778a5.tif, band 4: Setting nodata to

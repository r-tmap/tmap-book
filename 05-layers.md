...
#> options, oo, doo): GDAL Message 1: /tmp/Rtmpex2kL5/
#> file4851314e4a52.tif, band 2: Setting nodata to
...
#> Warning in CPL_gdalwarp(source, destination,
#> options, oo, doo): GDAL Message 1: /tmp/Rtmpex2kL5/
#> file4851314e4a52.tif, band 3: Setting nodata to
...
#> Warning in CPL_gdalwarp(source, destination,
#> options, oo, doo): GDAL Message 1: /tmp/Rtmpex2kL5/
#> file4851314e4a52.tif, band 4: Setting nodata to

...
#> options, oo, doo): GDAL Message 1: /tmp/RtmpjY8J2T/
#> file52a43b91e288.tif, band 2: Setting nodata to
...
#> Warning in CPL_gdalwarp(source, destination,
#> options, oo, doo): GDAL Message 1: /tmp/RtmpjY8J2T/
#> file52a43b91e288.tif, band 3: Setting nodata to
...
#> Warning in CPL_gdalwarp(source, destination,
#> options, oo, doo): GDAL Message 1: /tmp/RtmpjY8J2T/
#> file52a43b91e288.tif, band 4: Setting nodata to

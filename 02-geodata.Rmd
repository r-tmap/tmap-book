...
<!-- - stars proxy -->
`read_stars()` also has several additional arguments, such as `sub` allowing to read one subset of data (e.g. band) and `RasterIO` that gives control over the input data extent and resolution.

...
```{r vector-data-cubes, fig.width = 6, fig.asp=0.60606, message = FALSE, warning = FALSE, echo=FALSE, fig.cap="Vector data cubes."}
source("code/data_model_figures.R")
draw_vector_cubes()
```
...
```{r raster-data-cubes, fig.asp=0.25, message = FALSE, echo=FALSE, fig.cap="Raster data cubes."}
source("code/data_model_figures.R")
draw_data_cubes()
```

...
This chapter describes the vector (section \@ref(vector-data-model)) and raster (section \@ref(raster-data-model)) models, and how they can be used to create spatial data cubes (section \@ref(spatial-data-cubes)).
It also presents their implementations in R in the form of the **sf** (section \@ref(the-sf-package)) and **stars** (section \@ref(the-stars-package)) packages.

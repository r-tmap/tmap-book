...
```{r crs-02, eval=FALSE, echo=FALSE, results='hide', warning=FALSE}
...
```{r crs-trans-plot, echo=FALSE, warning=FALSE, fig.cap="Comparison between the same dataset of three waterfalls using: (A) the WGS84 coordinate system, (B) the Equal Earth projection."}

...
```{r vector-data-model, echo=FALSE, fig.width = 5, fig.asp = 1, fig.cap="Instances of spatial vector data model: POINTS, LINES, and POLYGONS."}
...
```{r vector-data-cubes, fig.asp=0.6667, message = FALSE, warning = FALSE, echo=FALSE, fig.cap="Vector data cubes."}
source("code/data_model_figures.R")
draw_vector_cubes()
```
...
```{r raster-data-cubes, fig.asp=0.5, message = FALSE, echo=FALSE, fig.cap="Raster data cubes."}
source("code/data_model_figures.R")
draw_data_cubes()
```

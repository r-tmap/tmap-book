...
```{r raster-intro, echo=FALSE, warning=FALSE, fig.cap="Basic representation of the raster data model: (1) Cell IDs, (2) Cell values, and (3) A raster map", message=FALSE}
...
```{r raster-data-cubes, echo=FALSE, message=FALSE, fig.cap="Add caption", fig.asp=0.5}
...
```{r crs-trans, warning=FALSE, warning=FALSE}
...
```{r crs-trans-plot, echo=FALSE, warning=FALSE}
tmap_arrange({
